...
import { Send, Bot, Sparkles, Lightbulb, Calendar, Target, AlertCircle, Loader2 } from 'lucide-react';
        ...
        <div className="p-4 border-b border-slate-100 flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-1.5">
              <span className={`w-1.5 h-1.5 rounded-full ${hasSession ? 'bg-green-500' : 'bg-amber-400'}`} />
              <span className="text-xs text-slate-500">
                {hasSession ? 'En línea · Adapta tu plan en tiempo real' : 'Modo demo'}
              </span>
            </div>
          </div>
